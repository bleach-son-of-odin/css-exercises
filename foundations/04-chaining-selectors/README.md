...
### Self Check
- Did you properly chain class selectors for each rule? i did
- Does the `proportioned` image retain its original square proportions? no, it didnt
- Does the `distorted` image end up looking squished and, well, distorted? true to the name!
